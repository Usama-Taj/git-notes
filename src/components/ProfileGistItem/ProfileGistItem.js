            ...
            <table>
              <tbody>
                ...
                <tr>
                  <td>5</td>
                  <td>
                    {` cout &lt;$lt &quot;Enter a positive integer: &quot;;
                cin &gt;&gt n;`}
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  <td>7</td>
                  <td>
                    {`  // loop to check if n is prime for (i = 2; i <= n/2;
                ++i) { if (n % i == 0) { is_prime = false; break; } }`}
                  </td>
                </tr>
                <tr>
                  <td>8</td>
